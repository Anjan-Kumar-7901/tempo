...
export default function Home() {
  ...
  return <section className="page">
    ...
    <div className="legend home-legend"><span><i className="logged"/>Logged period</span><span><i className="predicted"/>Predicted period</span><span><i className="ovulation"/>Ovulation window</span><span><i className="today"/>Today</span></div>
    ...
    <h2 className="section-title">Your rhythm</h2>
    <div className="stats-grid">
      ...
      <StatCard label="Cycle pattern" value={stats.regularity}/>
    </div>
